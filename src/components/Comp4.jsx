...
export default function Comp4() {
    return (
        <div>
            <section className='page-section headbackground text-white mb-0' id='about'>
